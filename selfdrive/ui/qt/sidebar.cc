...
void Sidebar::temp_drawMetric(QPainter &p, const QString &label, QColor c, int y) {
  ...
  p.drawText(r, Qt::AlignBottom | Qt::AlignCenter, label);
}
...
void Sidebar::paintEvent(QPaintEvent *event) {
  ...
  drawMetric(p, panda_status.first, panda_status.second, 525);
  drawMetric(p, connect_status.first, connect_status.second, 685);
}

...
QT_MOC_LITERAL(3, 24, 10), // "engageable"
QT_MOC_LITERAL(4, 35, 9), // "speedUnit"
QT_MOC_LITERAL(5, 45, 11), // "angleSteers"
QT_MOC_LITERAL(6, 57, 17), // "steerAngleDesired"
QT_MOC_LITERAL(7, 75, 8), // "dmActive"
QT_MOC_LITERAL(8, 84, 6), // "hideDM"
QT_MOC_LITERAL(9, 91, 6), // "status"
QT_MOC_LITERAL(10, 98, 11), // "lead_status"
QT_MOC_LITERAL(11, 110, 10), // "lead_d_rel"
QT_MOC_LITERAL(12, 121, 10), // "lead_v_rel"
QT_MOC_LITERAL(13, 132, 11), // "wifi_status"
QT_MOC_LITERAL(14, 144, 10), // "gps_status"
QT_MOC_LITERAL(15, 155, 10) // "gpsBearing"

    },
    "OnroadHud\0valueChanged\0\0engageable\0"
    "speedUnit\0angleSteers\0steerAngleDesired\0"
    "dmActive\0hideDM\0status\0lead_status\0"
    "lead_d_rel\0lead_v_rel\0wifi_status\0"
    "gps_status\0gpsBearing"
};
...
void OnroadHud::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->engageable; break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->speedUnit; break;
        case 2: *reinterpret_cast< float*>(_v) = _t->angleSteers; break;
        case 3: *reinterpret_cast< float*>(_v) = _t->steerAngleDesired; break;
        case 4: *reinterpret_cast< bool*>(_v) = _t->dmActive; break;
        case 5: *reinterpret_cast< bool*>(_v) = _t->hideDM; break;
        case 6: *reinterpret_cast< int*>(_v) = _t->status; break;
        case 7: *reinterpret_cast< int*>(_v) = _t->lead_status; break;
        case 8: *reinterpret_cast< float*>(_v) = _t->lead_d_rel; break;
        case 9: *reinterpret_cast< float*>(_v) = _t->lead_v_rel; break;
        case 10: *reinterpret_cast< int*>(_v) = _t->wifi_status; break;
        case 11: *reinterpret_cast< bool*>(_v) = _t->gps_status; break;
        case 12: *reinterpret_cast< float*>(_v) = _t->gpsBearing; break;
        default: break;
        }
        ...
        case 1:
            ...
            break;
        case 2:
            if (_t->angleSteers != *reinterpret_cast< float*>(_v)) {
                _t->angleSteers = *reinterpret_cast< float*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 3:
            if (_t->steerAngleDesired != *reinterpret_cast< float*>(_v)) {
                _t->steerAngleDesired = *reinterpret_cast< float*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 4:
        ...
        case 6:
            ...
            break;
        case 7:
            if (_t->lead_status != *reinterpret_cast< int*>(_v)) {
                _t->lead_status = *reinterpret_cast< int*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 8:
            if (_t->lead_d_rel != *reinterpret_cast< float*>(_v)) {
                _t->lead_d_rel = *reinterpret_cast< float*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 9:
            if (_t->lead_v_rel != *reinterpret_cast< float*>(_v)) {
                _t->lead_v_rel = *reinterpret_cast< float*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 10:
            if (_t->wifi_status != *reinterpret_cast< int*>(_v)) {
                _t->wifi_status = *reinterpret_cast< int*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 11:
            if (_t->gps_status != *reinterpret_cast< bool*>(_v)) {
                _t->gps_status = *reinterpret_cast< bool*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 12:
            if (_t->gpsBearing != *reinterpret_cast< float*>(_v)) {
                _t->gpsBearing = *reinterpret_cast< float*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        default: break;

...
struct qt_meta_stringdata_MenuControl_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MenuControl_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MenuControl_t qt_meta_stringdata_MenuControl = {
    {
QT_MOC_LITERAL(0, 0, 11) // "MenuControl"
...
static const uint qt_meta_data_MenuControl[] = {
...
QT_INIT_METAOBJECT const QMetaObject MenuControl::staticMetaObject = { {
    &AbstractControl::staticMetaObject,
    qt_meta_stringdata_MenuControl.data,
    qt_meta_data_MenuControl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_MenuControl.stringdata0))
        return static_cast<void*>(this);

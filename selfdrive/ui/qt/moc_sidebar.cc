...
QT_MOC_LITERAL(13, 125, 9), // "iPAddress"
QT_MOC_LITERAL(14, 135, 11), // "connectName"
QT_MOC_LITERAL(15, 147, 9), // "bATStatus"
QT_MOC_LITERAL(16, 157, 10), // "bATPercent"
QT_MOC_LITERAL(17, 168, 7), // "bATLess"
QT_MOC_LITERAL(18, 176, 4) // "rSRP"

    },
    "Sidebar\0openSettings\0\0valueChanged\0"
    "updateState\0UIState\0s\0connectStatus\0"
    "ItemStatus\0pandaStatus\0tempStatus\0"
    "netType\0netStrength\0iPAddress\0connectName\0"
    "bATStatus\0bATPercent\0bATLess\0rSRP"
};
...
void Sidebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: *reinterpret_cast< QString*>(_v) = _t->wifi_IPAddress; break;
        case 6: *reinterpret_cast< QString*>(_v) = _t->connect_Name; break;
        case 7: *reinterpret_cast< QString*>(_v) = _t->bat_Status; break;
        case 8: *reinterpret_cast< int*>(_v) = _t->bat_Percent; break;
        case 9: *reinterpret_cast< bool*>(_v) = _t->bat_Less; break;
        case 10: *reinterpret_cast< QString*>(_v) = _t->rsrp; break;
        default: break;
        }
        ...
        case 4:
            ...
            break;
        case 5:
            if (_t->wifi_IPAddress != *reinterpret_cast< QString*>(_v)) {
                _t->wifi_IPAddress = *reinterpret_cast< QString*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 6:
            if (_t->connect_Name != *reinterpret_cast< QString*>(_v)) {
                _t->connect_Name = *reinterpret_cast< QString*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 7:
            if (_t->bat_Status != *reinterpret_cast< QString*>(_v)) {
                _t->bat_Status = *reinterpret_cast< QString*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 8:
            if (_t->bat_Percent != *reinterpret_cast< int*>(_v)) {
                _t->bat_Percent = *reinterpret_cast< int*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 9:
            if (_t->bat_Less != *reinterpret_cast< bool*>(_v)) {
                _t->bat_Less = *reinterpret_cast< bool*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 10:
            if (_t->rsrp != *reinterpret_cast< QString*>(_v)) {
                _t->rsrp = *reinterpret_cast< QString*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        default: break;
